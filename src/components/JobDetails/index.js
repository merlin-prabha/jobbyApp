...
class JobDetails extends Component {
  ...
  formatJobDetails = data => ({
    ...
    location: data.location,
    packagePerAnnum: data.pachage_per_annum,
    rating: data.rating,
  ...
  getJobDetails = async () => {
    ...
    if (response.ok) {
      ...
      const updatedSimilarJobs = fetchedData.similar_jobs.map(eachData =>
        this.formatSimilarJobs(eachData),
      )
      this.setState({
        ...
        <div className="job-item">
          ...
          <ul className="skills-list-container">
            {skills.map(eachSkill => (
              <li className="skills-item-container" key={eachSkill.id}>
